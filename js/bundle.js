...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppMain = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ResultsView = __webpack_require__(254);

	var _ResultsView2 = _interopRequireDefault(_ResultsView);

	var _ImageView = __webpack_require__(255);
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_reactRouter.Route, { path: '/', component: _ResultsView2.default }),
							_react2.default.createElement(_reactRouter.Route, { path: '/image/:imageID', component: _ImageView2.default })
						)
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchHistory = __webpack_require__(195);

	var _SearchHistory2 = _interopRequireDefault(_SearchHistory);

	var _SortDropDown = __webpack_require__(196);

	var _SortDropDown2 = _interopRequireDefault(_SortDropDown);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var SideBarShape = function SideBarShape(_ref) {
		var onUpdateSortMethod = _ref.onUpdateSortMethod;
		var onUpdateSearchTerm = _ref.onUpdateSearchTerm;
		var searchHistory = _ref.searchHistory;
		return _react2.default.createElement(
			'aside',
			null,
			_react2.default.createElement(_SortDropDown2.default, { onUpdateSortMethod: onUpdateSortMethod }),
			_react2.default.createElement(_SearchBox2.default, { onUpdateSearchTerm: onUpdateSearchTerm }),
			_react2.default.createElement(_SearchHistory2.default, { searchHistory: searchHistory, onUpdateSearchTerm: onUpdateSearchTerm })
		);
	};

	SideBarShape.propTypes = {
		searchHistory: _react.PropTypes.array.isRequired,
		onUpdateSearchTerm: _react.PropTypes.func.isRequired
	};
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
		return {
			onUpdateSortMethod: function onUpdateSortMethod(newMethod) {
				dispatch((0, _actions.updateSortBy)(dispatch, newMethod));
			},
			onUpdateSearchTerm: function onUpdateSearchTerm(searchTerm) {
				dispatch((0, _actions.updateSearchTerm)(dispatch, searchTerm));
			}
		};
	};

	var SideBar = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(SideBarShape);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.selectFullImage = selectFullImage;
	exports.loadNextPage = loadNextPage;
	exports.loadPrevPage = loadPrevPage;
	exports.imageRequestBegin = imageRequestBegin;
	exports.imageRequestSuccess = imageRequestSuccess;
	exports.imageRequestError = imageRequestError;

	var _constants = __webpack_require__(192);

	var constants = _interopRequireWildcard(_constants);

	var _apis = __webpack_require__(193);
	...
	*/
	function updateSearchTerm(dispatch, searchTerm) {
		dispatch(imageRequestBegin(dispatch, (0, _apis.FlickrPhotoSearchURLBuilder)(searchTerm)));
	...
	* @return {Object} : action with updated values
	*/
	function updateSortBy(dispatch, sortBy) {
		var newSortBy = constants.SortByMethods[sortBy];
		dispatch(imageRequestBegin(dispatch, (0, _apis.FlickrPhotoSearchURLBuilder)(void 0, void 0, newSortBy)));
	...
	* @return {Object} : action with updated values
	*/
	function selectFullImage(imageID) {
		return {
	...
	* @return {Object} : action with updated values
	*/
	function loadNextPage(dispatch, currentPageNumber) {
		var newPageNumber = ++currentPageNumber;
		dispatch(imageRequestBegin(dispatch, (0, _apis.FlickrPhotoSearchURLBuilder)(void 0, newPageNumber)));
	...
	* @return {Object} : action with updated values
	*/
	function loadPrevPage(dispatch, currentPageNumber) {
	...
	* @return {Object} : action with updated values
	*/
	function imageRequestBegin(dispatch, url) {
		(0, _apis.SendGetReq)(url, function (successData) {
	...
	* @return {Object} : action with updated values
	*/
	function imageRequestSuccess(receivedData) {
		return {
	...
	* @return {Object} : action with updated values
	*/
	function imageRequestError(receivedData) {
		return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	exports.SendGetReq = function (url, successCallback, errorCallback) {
		if (!url) return;

		var req = new XMLHttpRequest();
		req.open('GET', url, true);
		req.onload = function () {
			if (req.status >= 200 && req.status < 400) successCallback(req.responseText);else errorCallback('error ' + req.status + ' returned from ' + url);
		};
	...
	*/
	var argCache = {
		searchTerm: '',
		resultsPage: '1',
		sortByMethod: _constants.DefaultSortByMethod
	};
	...
	*/
	exports.FlickrPhotoSearchURLBuilder = function () {
		var searchTerm = arguments.length <= 0 || arguments[0] === undefined ? argCache.searchTerm : arguments[0];
		var resultsPage = arguments.length <= 1 || arguments[1] === undefined ? argCache.resultsPage : arguments[1];
		var sortByMethod = arguments.length <= 2 || arguments[2] === undefined ? argCache.sortByMethod : arguments[2];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBox = function SearchBox(_ref) {
		...
		var inputElementDefaultVal = 'try toronto? maybe sunset?';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchHistory = function SearchHistory(_ref) {
		...
		return _react2.default.createElement(
			...
			searchHistory.map(function (historyItem) {
				return _react2.default.createElement(
					"li",
					{ key: historyItem.searchID, href: "#", onClick: function onClick(e) {
							e.preventDefault();
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				{ ref: function ref(node) {
						...
						return onUpdateSortMethod(selectElement.value);
					} },
				Object.keys(constants.SortByMethods).map(function (sortMethod, index, methodsArray) {
					return _react2.default.createElement(
						'option',
						{ key: sortMethod, value: sortMethod },
						methodsArray[index]
					);
				})
			)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateHashHistory = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultsViewShape = _react2.default.createClass({
		displayName: 'ResultsViewShape',
		render: function render() {
			var _this = this;

			// make sure to display error data if we receive any
			if (this.props.errorData) return _react2.default.createElement(
				'div',
				{ className: 'viewArea' },
				_react2.default.createElement(
					'div',
					{ 'class': 'viewArea--errorData' },
					this.props.errorData
				)
			);

			// display a spinner if a request is in progress
			if (this.props.isFetching) return _react2.default.createElement(
				'div',
				{ className: 'viewArea' },
				_react2.default.createElement('div', { 'class': 'loading-spinner' })
			);

			// display a message if the images array isn't populated (default state, or invalid search term)
			if (this.props.images.length < 1) return _react2.default.createElement(
				'div',
				{ className: 'viewArea' },
				_react2.default.createElement(
					'div',
					{ className: 'viewArea--noImg' },
					_react2.default.createElement(
						'h1',
						null,
						'No image results :('
					...
					_react2.default.createElement(
						'h2',
						null,
						'Enter a new search term to find some!'
					)
				)
			);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'viewArea--controls' },
					_react2.default.createElement(
						'a',
						{ href: '#', onClick: function onClick(e) {
								return _this.props.prevPageClick(e, _this.props.imagePageNumber);
							} },
						'<<'
					),
					_react2.default.createElement(
						...
						null,
						'Page ',
						this.props.imagePageNumber
					),
					_react2.default.createElement(
						'a',
						{ href: '#', onClick: function onClick(e) {
								return _this.props.nextPageClick(e, _this.props.imagePageNumber);
							} },
						'>>'
					)
				),
					...
					this.props.images.map(function (image) {
						return _react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ to: '/image/' + image.id },
								_react2.default.createElement('img', { src: image.url_s })
							)
						);
					})
				)
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
		return {
			nextPageClick: function nextPageClick(e, currentPageNumber) {
				e.preventDefault();
				dispatch((0, _actions.loadNextPage)(dispatch, parseInt(currentPageNumber)));
			},
			prevPageClick: function prevPageClick(e, currentPageNumber) {
				e.preventDefault();
				if (currentPageNumber > 1) dispatch((0, _actions.loadPrevPage)(dispatch, currentPageNumber));
			}
		};
	};

	var ResultsView = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ResultsViewShape);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageViewShape = _react2.default.createClass({
		displayName: 'ImageViewShape',
		render: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'viewArea' },
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ href: 'https://www.flickr.com/photos/' + this.props.image.owner + '/' + this.props.image.id + '/', target: '_blank' },
						' | View on Flickr'
					)
				),
				_react2.default.createElement(
	...
	var mapStateToProps = function mapStateToProps(state, ownProps) {
		return {
			image: state.imgThumbCollection.images.find(function (img) {
				return img.id === ownProps.params.imageID;
			}) // only pass down the single image we care about
		};
	};

	var ImageView = (0, _reactRedux.connect)(mapStateToProps)(ImageViewShape);
	...
	function imgThumbCollection() {
		...
		switch (action.type) {
			case constants.ActionTypes.updateSearchTerm:
				...
				if (state.searchHistory.length > 0 && action.searchTerm === state.searchHistory[0].searchTerm) return state;

				var newHistory = [{
					searchTerm: action.searchTerm,
					searchID: action.searchID
				}].concat(_toConsumableArray(state.searchHistory));
